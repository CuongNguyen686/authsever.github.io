...
export async function renderPackages(v){
  ...
  <div class="section-card"><div class="table-wrap"><table class="data-table"><thead><tr><th>ID package</th><th>Tên</th><th>Token</th><th>Phiên bản</th><th>Min</th><th>Max</th><th>Trạng thái</th><th>Mô tả</th><th>Thao tác</th></tr></thead>
  ...
  :`<tr><td colspan="9"><div class="empty">Chưa có package nào.</div></td></tr>`}</tbody></table></div></div>`;
...
function form(v,x={}){
  ...
  <div class="field"><label>ID package</label><input name="packageId" required value="${esc(x.packageId||"")}"></div>
