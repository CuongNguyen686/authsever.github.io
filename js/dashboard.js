...
const routes={dashboard:["Tổng quan",renderDashboard],keys:["Khóa",renderKeys],devices:["Thiết bị",renderDevices],packages:["Package",renderPackages],tweaks:["Tweak",renderTweaks],blacklist:["Danh sách chặn",renderBlacklist],logs:["Nhật ký",renderLogs],statistics:["Thống kê",renderDashboard],docs:["Tài liệu API",renderDocs],settings:["Cài đặt",renderSettings]};
